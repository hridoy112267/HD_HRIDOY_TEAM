...
<div class="container">
    ...
    <div class="developer-name">Developed by HD_HRIDOY</div> <!-- Added Developer Name -->


<center><script type='text/javascript'>(function() {var script=document.createElement('script');script.type='text/javascript';script.async =true;script.src='//telegram.im/widget-button/index.php?id=@HD_HACKER_TEAM';document.getElementsByTagName('head')[0].appendChild(script);})();</script><a href='https://t.me/HD_HACKER_TEAM' target='_blank' class='telegramim_button telegramim_shadow telegramim_pulse' style='font-size:15px;max-width:300px;height:35px;background:red;box-shadow:3px 3px 3px red;color:white;border-radius:10px;' title='Join Now'><i>Telegram </i> <small><span class='telegramim_count' data-for='@HD_HACKER_TEAM'></span></small></a></center>
</div>
